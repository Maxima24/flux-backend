...
function nextApproximate(state) {
    ...
    const { computePxAndPxPrimeofX, computeFxofX, xFactor, pxFactor, edge } = invariants;
    //@ts-ignore
    let [xN, pxN, pxNPrime] = Xterms[Xterms.length - 1];
