...
export declare const witdrawalOptimalWorkflow: import("@langchain/langgraph").CompiledStateGraph<{
    agentAddress: string;
    ...
    maxValuesInRanges?: [bigint, bigint][];
    transactions?: Transaction[];
}, "__start__" | "fetchAaveDetails" | "fetchCompDetails" | "checkIdleBalance" | "fetchConstants" | "fetchBalances" | "initiateRangeWorkers" | "getMaxValueWithinRange" | "generateTransactions", {
    agentAddress: {
    ...
    withdrawAmount: {
        (): import("@langchain/langgraph").LastValue<bigint>;
        (annotation: import("@langchain/langgraph").SingleReducer<bigint, bigint>): import("@langchain/langgraph").BinaryOperatorAggregate<bigint, bigint>;
        Root: <S extends import("@langchain/langgraph").StateDefinition>(sd: S) => import("@langchain/langgraph").AnnotationRoot<S>;
    };
    withdrawableAmount: {
        (): import("@langchain/langgraph").LastValue<bigint>;
    ...
    checkIdleBalance: import("@langchain/langgraph").UpdateType<{
        agentAddress: {
            (): import("@langchain/langgraph").LastValue<string>;
            (annotation: import("@langchain/langgraph").SingleReducer<string, string>): import("@langchain/langgraph").BinaryOperatorAggregate<string, string>;
            Root: <S extends import("@langchain/langgraph").StateDefinition>(sd: S) => import("@langchain/langgraph").AnnotationRoot<S>;
